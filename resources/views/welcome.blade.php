...
<body>
	<nav class="navbar navbar-expand-lg navbar-successs bg-success">
	<a class="nav-link" href="{{ route('c-d-d') }}">Acceuil</a>
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a class="nav-link" href="{{ route('candidats.index') }}">Ajouter un candidats</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="{{ route('types.index') }}">Liste des types</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="{{ route('referentiels.index') }}">Liste des références</a>
			</li>
			<li class="nav-item">
